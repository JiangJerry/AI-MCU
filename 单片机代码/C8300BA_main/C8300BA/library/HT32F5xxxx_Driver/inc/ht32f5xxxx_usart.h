...
#define IS_USART_TL(x)                (IS_USART_RXTL(x) || \
                                       IS_USART_TXTL(x))
...
#define IS_USART_INT(INT)             ((INT == USART_INT_RXDR)  || \
                                       (INT == USART_INT_TXDE)  || \
                                       (INT == USART_INT_TXC)   || \
                                       (INT == USART_INT_OE)    || \
                                       (INT == USART_INT_PE)    || \
...
//void USART_RXTLConfig(HT_USART_TypeDef* USARTx, u32 USART_RFITL);
//void USART_TXTLConfig(HT_USART_TypeDef* USARTx, u32 USART_TFITL);
