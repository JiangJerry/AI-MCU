...
int16_t Si114xBlockWrite(uint8_t  address,
												 uint8_t* values,
                         uint8_t  length
                         );
int16_t Si114xBlockRead(uint8_t  address, 
                        uint8_t  length, 
                        uint8_t* values);
...
int16_t  si114x_get_calibration(SI114X_CAL_S* si114x_cal,
                                uint8_t security);
int16_t si114x_set_ucoef(uint8_t* input_ucoef,
